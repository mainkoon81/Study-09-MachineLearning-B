...
<img src="https://user-images.githubusercontent.com/31917400/54868895-690f9d00-4d89-11e9-9ea3-1a2ea1bf97db.jpg" />   
...
### `NN's each "NODE" is a linear model(classifier) with so many featuresssss whose weights(parameters) are updated by the optimization algorithm like a Gradient_Descent that minimizing the cost function("MSE" for regression form, "CrossEntropy" for logistic regression form), and this linear model(classifier) becomes the input of the activation function (step for discrete, sigmoid for continous) that returns the outcome of either classification/probability`.  
...
<img src="https://user-images.githubusercontent.com/31917400/41513241-c800bf58-7290-11e8-9523-877bb5cf7e32.jpg" />
